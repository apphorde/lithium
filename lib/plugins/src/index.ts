...
} from "./plugins/property-binding.plugin.js";
...
export { connectDataModel } from "./plugins/for-model.plugin.js";

export type RuntimeContextExtensions = RuntimeContext &
  InjectResourcesExtension &
  HostPropertiesExtension;
