...
export { addScriptToPage, adoptStyleSheet, injectStylesheetOnElement } from './plugins/inject-resources.plugin.js';
...
export { applyHostAttributes } from './plugins/host-properties.plugin.js';
